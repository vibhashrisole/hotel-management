...
public class MenuCardController {
	...
	public MenuCard findItemsById(@PathVariable String items) {
		return service.findById(items);	
	}
	...
	public String deleteItem(@PathVariable String items) {
		return service.deleteByItems(items);
	}
